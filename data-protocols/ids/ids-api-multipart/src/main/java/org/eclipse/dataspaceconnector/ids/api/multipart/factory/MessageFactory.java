...
public class MessageFactory {
    ...
    public DescriptionResponseMessage createDescriptionResponseMessage(
            final Message correlationMessage) {
    ...
    public RejectionMessage createRejectionMessage(final Message correlationMessage) {
        final IdsId messageId = IdsId.message(UUID.randomUUID().toString());

        final RejectionMessageBuilder builder = new RejectionMessageBuilder(messageId.toUri());
