...
public class ArtifactDescriptionRequestHandlerSettingsFactory {
    private final SettingResolver settingResolver;

    public ArtifactDescriptionRequestHandlerSettingsFactory(@NotNull SettingResolver settingResolver) {
