...
public class ContractOfferFactoryTest {
    ...
    void testContractOfferFactoryReturnsValidOffer() {
        ...
        // invoke
        final de.fraunhofer.iais.eis.ContractOffer result = contractOfferFactory.createContractOffer(contractOffer).orElseThrow();
        ...
        final String assetIdValue = IdsId.fromUri(result.getPermission().get(0).getTarget()).getValue();
