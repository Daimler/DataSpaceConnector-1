...
public class MultipartRequestHandlerResolver {
    ...
    public MultipartRequestHandlerResolver(final MultipartRequestHandler... multipartRequestHandlers) {
        this(Arrays.asList(multipartRequestHandlers));
    }

    public MultipartRequestHandlerResolver(
            final List<MultipartRequestHandler> multipartRequestHandlers) {
    ...
    @NotNull
    public Optional<MultipartRequestHandler> resolveHandler(final MultipartRequest multipartRequest) {
