...
public class ContractOfferFactory {
    ...
    private ContractOffer createOffer(
        ...
        final ZonedDateTime contractStart = contractOffer.getContractStart();
        final ZonedDateTime contractEnd = contractOffer.getContractEnd();
    ...
    private XMLGregorianCalendar mapToXmlGregorianCalendar(final ZonedDateTime zonedDateTime) {
    ...
    private List<Permission> createPermissions(final Asset asset,
                                               final Policy policy,
                                               final URI consumer,
                                               final URI provider) {
