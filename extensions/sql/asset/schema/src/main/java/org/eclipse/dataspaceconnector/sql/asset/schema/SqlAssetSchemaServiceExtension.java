...
public class SqlAssetSchemaServiceExtension implements ServiceExtension {
    private static final String MIGRATION_LOCATION = String.format("classpath:%s", SqlAssetSchemaServiceExtension.class.getPackageName().replaceAll("\\.", "/"));
    ...
    private String getSchemaHistoryTableName(String suffix) {
        return String.format("flyway_schema_history_asset_%s", suffix);
    }
}
