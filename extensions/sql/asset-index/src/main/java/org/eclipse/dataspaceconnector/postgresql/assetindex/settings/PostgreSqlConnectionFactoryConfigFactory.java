...
public class PostgreSqlConnectionFactoryConfigFactory {

    private static final String LOG_INVALID_NUMBER = "AssetIndex-PostgreSQL-Configuration: Expecting number in property %s";
    private static final String LOG_URL_USERNAME_REQUIRED = "AssetIndex-PostgreSQL-Configuration: Username (%s) and url (%s) must be provided in the settings";
    private static final String LOG_INVALID_URI = "AssetIndex-PostgreSQL-Configuration: Invalid URI syntax in setting %s.";
    private static final String LOG_FILE_NOT_EXISTS = "AssetIndex-PostgreSQL-Configuration: File does not exist: %s.";
    private static final String LOG_INVALID_PATH = "AssetIndex-PostgreSQL-Configuration: Invalid path in setting %s";
    private static final String LOG_INVALID_ENUM = "AssetIndex-PostgreSQL-Configuration: Invalid configuration for %s. Valid settings: %s";
    private static final String EXCEPTION_INVALID_SETTINGS = "AssetIndex-PostgreSQL-Configuration: Invalid or incomplete PostgreSQL settings.";

    private final ServiceExtensionContext serviceExtensionContext;
    private final Monitor monitor;

    public PostgreSqlConnectionFactoryConfigFactory(@NotNull ServiceExtensionContext serviceExtensionContext) {
