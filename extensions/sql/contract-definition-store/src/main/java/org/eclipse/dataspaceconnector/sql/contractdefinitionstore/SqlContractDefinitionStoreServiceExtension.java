...
public class SqlContractDefinitionStoreServiceExtension implements ServiceExtension {
    ...
    @Override
    public String name() {
        return "SQL Contract Definition Store Service Extension";
    }
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        ContractDefinitionStore contractDefinitionStore = new SqlContractDefinitionStore(dataSource, transactionContext);
        context.registerService(ContractDefinitionStore.class, contractDefinitionStore);
