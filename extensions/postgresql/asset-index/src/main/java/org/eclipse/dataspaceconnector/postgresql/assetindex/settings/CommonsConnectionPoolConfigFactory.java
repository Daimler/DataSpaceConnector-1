...
public class CommonsConnectionPoolConfigFactory {
    ...
    private static final String LOG_INVALID_NUMBER = "AssetIndex-ConnectionPool-Configuration: Expecting number in property %s";
    private static final String EXCEPTION_INVALID_SETTINGS = "AssetIndex-ConnectionPool-Configuration: Invalid ConnectionPool settings.";
