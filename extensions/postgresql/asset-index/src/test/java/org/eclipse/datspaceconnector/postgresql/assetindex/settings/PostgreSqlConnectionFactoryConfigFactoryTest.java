...
import org.eclipse.dataspaceconnector.postgresql.assetindex.settings.PostgreSqlConnectionFactoryConfigFactory;
...
public class PostgreSqlConnectionFactoryConfigFactoryTest {

    private static final int TOTAL_SETTINGS_COUNT = 17;

    private PostgreSqlConnectionFactoryConfigFactory factory;
    ...
    public void setup() {
        ...
        factory = new PostgreSqlConnectionFactoryConfigFactory(serviceExtensionContext);
    }
