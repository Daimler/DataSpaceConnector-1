...
package org.eclipse.dataspaceconnector.api.data.settings;
...
public class ConnectionFactoryConfigFactory {
    ...
    private static final String LOG_INVALID_NUMBER = "Datalog-Management-API-PostgreSQL-Configuration: Expecting number in property %s";
    private static final String LOG_URL_USERNAME_REQUIRED = "Datalog-Management-API-PostgreSQL-Configuration: Username (%s) and url (%s) must be provided in the settings";
    private static final String LOG_INVALID_URI = "Datalog-Management-API-PostgreSQL-Configuration: Invalid URI syntax in setting %s.";
    private static final String LOG_FILE_NOT_EXISTS = "Datalog-Management-API-PostgreSQL-Configuration: File does not exist: %s.";
    private static final String LOG_INVALID_PATH = "Datalog-Management-API-PostgreSQL-Configuration: Invalid path in setting %s";
    private static final String LOG_INVALID_ENUM = "Datalog-Management-API-PostgreSQL-Configuration: Invalid configuration for %s. Valid settings: %s";
    private static final String EXCEPTION_INVALID_SETTINGS = "Datalog-Management-API-PostgreSQL-Configuration: Invalid or incomplete PostgreSQL settings.";
