...
public class CommonsConnectionPoolConfigFactory {
    ...
    private static final String LOG_INVALID_NUMBER = "Datalog-Management-API-ConnectionPool-Configuration: Expecting number in property %s";
    private static final String EXCEPTION_INVALID_SETTINGS = "Datalog-Management-API-ConnectionPool-Configuration: Invalid ConnectionPool settings.";
