...
public class TransactionalPoolDecorator implements ConnectionPool {

    private final ConnectionPool delegate;
    private final SqlTransactionManager transactionManager;

    public TransactionalPoolDecorator(ConnectionPool delegate, SqlTransactionManager transactionManager) {
    ...
    public void returnConnection(Connection connection) throws SQLException {
        ...
        if (connection instanceof MyConnection) {
            delegate.returnConnection(((MyConnection) connection).delegate);
        } else {
            delegate.returnConnection(connection);
        }
    }
