...
public class ContractDefinitionMapper implements ResultSetMapper<ContractDefinition> {
    ...
    @Override
    public ContractDefinition mapResultSet(ResultSet resultSet) throws SQLException {
