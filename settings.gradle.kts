...
include(":extensions:data-mgt:dm-client")
...
include(":extensions:azure:contract-definition-store-cosmos")
include(":extensions:azure:contract-negotiation-store-cosmos")
