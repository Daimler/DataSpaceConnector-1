...
include(":data-protocols:ids:ids-sample-data-flow")
...
include(":extensions:azure:fcc-node-directory-cosmos")
include(":extensions:azure:vault")
include(":extensions:azure:blob:api")
include(":extensions:azure:cosmos-common")
include(":extensions:azure:assetindex-cosmos")
...
include(":extensions:in-memory:fcc-catalogquery-adapter-registry-memory")
include(":extensions:in-memory:fcc-query-adapter-registry-memory")
